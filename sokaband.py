...
# Editor: Pedro Arteta <pedroarteta@hotmail.es>
# Date: 2025
...
def move_player(direction: str):
    ...
    if direction.upper() in ["L", "R", "U", "D"]:
        ...
        return {"message": f"Moved {direction}", "state": get_game_state()}
    return {"error": "Invalid direction. Use L, R, U, or D."}
...
def reset_level():
    ...
    return {"message": "Level reset", "state": get_game_state()}
